...
fn should_mark_ui_dirty_for_key(app: &SessionManager, key: &KeyEvent) -> bool {
    ...
    let direct_terminal_input =
        terminal_view_active && !terminal_search_active && app.quick_connect.is_none() && app.vault_unlock.is_none() && !app.search_mode;
